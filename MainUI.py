...
def button_Teacher():
    ...
    l1=ctk.CTkLabel(master=frame, text="Teacher's Login",font=('Century Gothic', 30))
    l1.place(x=50, y=45)
...
def button_Student():
    ...
    button4 = ctk.CTkButton(master=frame, text="View Attendance", width=220 , font= ("Comic Sans MS",15 ) , command = Excel , corner_radius=6)
...
l1=ctk.CTkLabel(master=frame, text="Select Your Profile",font=('Century Gothic', 30))
l1.place(x=50, y=45)

button1 = ctk.CTkButton(master=frame, width=180, text="Teacher", command=button_Teacher, corner_radius=6)
button1.place(x=50, y=140)

button2 = ctk.CTkButton(master=frame, width=180, text="Student", command=button_Student, corner_radius=6)
button2.place(x=300, y=140)
